...
export function PerformersTab({ performers, seriesId }) {
  ...
  return (
    <div className="pt-6 flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between">
        ...
        {/* "+ Add to series" — requires a performer-picker modal; stub for now */}
        <Link
          href={`/dashboard/performers?addTo=${seriesId}`}
