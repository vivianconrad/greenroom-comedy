...
import { CreateSeriesModal } from '@/components/organisms/forms/create-series-modal'
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="shrink-0 border-t border-peach px-2 py-3 space-y-0.5">
        ...
        <NavLink href="/dashboard/contacts">
          <FontAwesomeIcon icon={faAddressBook} className="h-4 w-4 shrink-0" aria-hidden="true" />
          Contacts
        </NavLink>
